    ...
    <div style={styles.page}>
      <header style={styles.header}>
        ...
        <nav style={styles.nav}>
          ...
          <Link to="/upload" style={{ color: "#000", fontWeight: 700 }}>
            Upload
          </Link>
          <Link to="/profile" style={{ ...styles.link, fontWeight: 700 }}>
            Profile
          </Link>
        </nav>
      ...
      <main style={{ flex: 1 }}>
        <div style={styles.container}>
          <section style={styles.leftCard}>
            ...
            <div style={styles.dropArea} onClick={openFilePicker}>
              <div
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button
                  style={{ ...styles.btnPrimary, ...styles.btnPrimaryIcon }}
              ...
              <div style={styles.pillsRow}>
                <div style={{ position: "relative" }}>
                  <div
                    ...
                    onClick={() =>
                      setOpenDropdown(
                        openDropdown === "jurusan" ? null : "jurusan"
                      )
                    }
                  >
                    {jurusan || "Jurusan"}
                ...
                <div style={{ position: "relative" }}>
                  <div
                    ...
                    onClick={() =>
                      setOpenDropdown(
                        openDropdown === "tingkat" ? null : "tingkat"
                      )
                    }
                  >
